...
console.log(first); //Cave of Wonders
console.log(second); // Lake of Mystery
console.log(remaining); // { third: 'Mount of Ages', fourth: 'Desert of Shadows' }
...
console.log(firstElement); // Fire
console.log(secondElement); // Water
console.log(`Essential elements: ${firstElement}  and  ${secondElement}`) 
// Essential elements: Fire  and  Water
...
console.log(`the selected stones are ${firstStone} and ${sixthStone}`); 
// the selected stones are 1 and 6
...
console.log(`visible shadows are ${visible} and all the hidden shadows are ${hidden}`);
// visible shadows are Darkness and all the hidden shadows are Silence,Whisper,Echo
...
function revealPath ({ direction, distance}) {
	console.log(`Travel ${distance} miles to the ${direction}` )
}; 
revealPath({direction: "North", distance: 567});
// Travel 567 miles to the North
...
mixPotion({ ingredient1: "Galaxy Dust"});
// Mixing Galaxy Dust with Fireflower
...
castSpell(["Stardust", "Carbon dust"]); 
// Casting spell with Stardust and Carbon dust
...
console.log(`the secret is revealed, ${inner}`);
// the secret is revealed, The Final Key
